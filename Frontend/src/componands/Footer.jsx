...
// import "../../public/css/Footer.css"; // Import the CSS for animations
...
//   return (
//     <footer className={`footer-container ${visible ? "fade-in" : ""} mt-20`}>
//       <div className="footer-content">
//         <h2 className="footer-title">Books World 📚</h2>
//         <p className="footer-text">Discover the best free books and courses to expand your knowledge!</p>
...
//         </div>
//       </div>
//       <p className="footer-bottom">&copy; 2025 Books World. All rights reserved.</p>
//     </footer>
//   );
// };
...
import React, { useEffect, useState } from "react";
import { FaFacebook, FaInstagram, FaTwitter, FaLinkedin } from "react-icons/fa";
import "../../public/css/Footer.css"; // Import the updated CSS
...
const Footer = () => {
  ...
  return (
    <footer className={`footer-container ${visible ? "slide-up" : ""} mt-20`}>
      <div className="footer-content">
        <h2 className="footer-title">Books World 📚</h2>
        <p className="footer-text">Discover the best free books and courses to expand your knowledge!</p>
